...
namespace PUCIT.AIMRL.TLS.UI.Common
{
    public static class SessionManager
    {
        ...
        public static PUCIT.AIMRL.TLS.Entities.DBEntities.Users UserForSignUp
        {
            get
            {
                if (System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session[USER_KEY] != null)
                {
                    return System.Web.HttpContext.Current.Session[USER_KEY] as Users;
                }
                else
                    return null;
            }
        ...
        public static PUCIT.AIMRL.TLS.Entities.Security.SecUserDTO CurrentUser
        {
            get
            {
                if (System.Web.HttpContext.Current.Session != null && System.Web.HttpContext.Current.Session[USER_KEY] != null)
                    return System.Web.HttpContext.Current.Session[USER_KEY] as PUCIT.AIMRL.TLS.Entities.Security.SecUserDTO;
                else
                    return null;
            }
            set
